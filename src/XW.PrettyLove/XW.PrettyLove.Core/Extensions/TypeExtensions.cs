...
namespace XW.PrettyLove.Core
{
    ...
    public static class TypeExtensions
    {
        ...
        public static object GetDefaultValue(this Type type)
        {
            ...
            var dva = typeInfo.GetAttribute<DefaultValueAttribute>();
            if (dva != null)
            {
        ...
        public static bool IsAnonymous(this Type type)
        {
            ...
            return !typeInfo.IsPublic
               && typeInfo.IsSealed
               && typeInfo.GetCustomAttributes(typeof(CompilerGeneratedAttribute), false).Length > 0
        ...
        {
            return !typeof(System.Collections.IEnumerable).IsAssignableFrom(type) && !type.IsSimpleType();
        }
        ...
        public static object Parse(this Type type, object value)
        {
            ...
            if (typeof(System.Collections.IList).IsAssignableFrom(type) && value is System.Collections.IList source)
            {
                if (type.IsArray)
                {
                ...
                {
                    var target = (System.Collections.IList)Activator.CreateInstance(type);
        ...
        /// <summary>
        /// 解包Task类型获取其实际返回类型
        /// typeof(Task).UnwrapTask() => typeof(void)
        /// typeof(Task<string></string>).UnwrapTask() => typeof(string)
        /// typeof(Task<int>).UnwrapTask() => typeof(int)
        /// </summary>
        /// <param name="type"></param>
        /// <returns></returns>
        public static Type UnwrapTask([NotNull] this Type type)
        {
            if (type == typeof(Task))
            {
                return typeof(void);
