...
namespace XW.PrettyLove.Core
{
    ...
    /// LambadaExpression扩展
    /// </summary>
    public static class LambadaExpressionExtension
    {
        static LambdaExpression InternalAndOrExpression(bool condition, LambdaExpression exp1, LambdaExpression exp2, bool isAndAlso)
        {
            ...
            var newParameters = exp1.Parameters.Select((a, b) => Expression.Parameter(a.Type, a.Name)).ToArray();
        ...
        static LambdaExpression InternalNotExpression(bool condition, LambdaExpression exp)
        {
            ...
            var newParameters = exp.Parameters.Select((a, b) => Expression.Parameter(a.Type, a.Name)).ToArray();
        ...
        /// </summary>
        /// <param name="exp"></param>
        /// <param name="tolistObjectExpOut"></param>
        /// <param name="toListMethodOut"></param>
        /// <param name="toListArgs0Out"></param>
        /// <returns></returns>
