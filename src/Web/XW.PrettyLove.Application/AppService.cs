...
namespace XW.PrettyLove.Application
{
    ...
    public class AppService<TEntity> : AppService<TEntity, long>, IAppService<TEntity>
        where TEntity : class, IEntity<long>, new()
    {
        public AppService(IGenericRepository<TEntity, long> repository)
            : base(repository)
        {
    ...
    public class AppService<TEntity, TKey> : IAppService<TEntity, TKey>
        ...
        where TKey : struct, IEquatable<TKey>
    {
        ...
        public AppService(IGenericRepository<TEntity, TKey> repository)
        {
