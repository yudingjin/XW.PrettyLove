...
namespace XW.PrettyLove.Application
{
    ...
    public record ChildrenDTO(long? Id, string Name, MaritalStatus? MaritalStatus, ExpectedMarriageTime? ExpectedMarriageTime, Religion? Religion, string Nationality, string Hometown, string Address, string House, string VehicleInfo, BodyType? BodyType, Gender? Gender, Education? Education, IncomLevel IncomLevel, int? Height, string Remark);
}
